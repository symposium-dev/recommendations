...
* `cargo agents info $CRATE_NAME` will give you the source path for the crate, preferring to use the version found in your current package. If the crate is not yet used, it will give you the latest version.
* `cargo agents info $CRATE_NAME --version $VERSION` will give you the source path for a specific version
